      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="javascript:document.getElementById('form1').submit()">Consulter Tickets   <span class="glyphicon glyphicon-tags"></span></a></li>
          	<li><a href="/monprojet2/creerticket">Soumettre Ticket   <span class="glyphicon glyphicon-tag"></span></a></li>
