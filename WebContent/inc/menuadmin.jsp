      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="/monprojet2/consulterstats">Statistiques   <span class="glyphicon glyphicon-stats"></span></a></li>
            <li><a href="javascript:document.getElementById('form1').submit()">Gérer Comptes  <span class="glyphicon glyphicon-pencil"></span></a></li>
...
<div id="menu">
<form action="<c:url value="/gestioncomptes"/>" method="post" id="form1">
</form>
</div><br>
...
<div>
<form method="get" action="creerticket">
<input type="hidden" name="idemp" value="${masession.idemp}">
</form>
</div>
<br>
<div>
<form method="post" action="afficherfaq">
<%-- <input type="hidden" name="idemp" value="${masession.idemp}">--%>
</form>
</div>
</fieldset>
