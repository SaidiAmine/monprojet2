...
<div class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="javascript:document.getElementById('form2').submit()">Depot Tickets    <span class="glyphicon glyphicon-inbox"></span></a></li>
          	<li><a href="javascript:document.getElementById('form1').submit()">Assignations   <span class="glyphicon glyphicon-pushpin"></span></a></li>
          	<li><a href="javascript:document.getElementById('form3').submit()">FAQ   <span class="glyphicon glyphicon-question-sign"></span> </a></li>
          	<li><a href="/monprojet2/deconnexion">Deconnexion   <span class="glyphicon glyphicon-off"></span></a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
</div>
	...
	<form action="<c:url value="/assignerticket"/>" method="post" id="form1">
	</form>
